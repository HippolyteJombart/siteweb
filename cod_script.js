var indice= 0;
const image_joueurs = [];
image_joueurs.push("./Image/joueurs/cod/sib.png","./Image/joueurs/cod/neptune.png","./Image/joueurs/cod/ghosty.png","./Image/joueurs/cod/envoy.png")
const pseudo_joueurs = [];
pseudo_joueurs.push("Sib", "Neptune", "Ghosty", "Envoy")
const texte_joueurs = [];
