var indice= 0;
const image_joueurs = [];
image_joueurs.push("./Image/joueurs/fortnite/akiraa.png", "./Image/joueurs/fortnite/marius.png", "./Image/joueurs/fortnite/pollo.png", "./Image/joueurs/fortnite/vanyak.png", "./Image/joueurs/fortnite/merstach.png", "./Image/joueurs/fortnite/nikof.png")
const pseudo_joueurs = [];
pseudo_joueurs.push("Akiraa", "Marius", "Pollo", "Vanyak", "Merstach", "Nikof")
const texte_joueurs = [];
