var indice= 0;
const image_joueurs = [];
image_joueurs.push("./Image/joueurs/cs/alex.png","./Image/joueurs/cs/mopoz.png","./Image/joueurs/cs/dav1g.png","./Image/joueurs/cs/martinez.png","./Image/joueurs/cs/sausol.png")
const pseudo_joueurs = [];
pseudo_joueurs.push("Alex", "Mopoz", "Dav1g", "Martinez", "Sausol")
const texte_joueurs = [];
