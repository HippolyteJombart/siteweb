var indice= 0;
const image_joueurs = [];
image_joueurs.push("./Image/joueurs/valorant/minny.png","./Image/joueurs/valorant/marteen.png","./Image/joueurs/valorant/starxo.png","./Image/joueurs/valorant/glyph.png","./Image/joueurs/valorant/bipo.png")
const pseudo_joueurs = [];
pseudo_joueurs.push("Minny", "Marteen", "Starxo", "Glyph", "Bipo")
const texte_joueurs = [];
